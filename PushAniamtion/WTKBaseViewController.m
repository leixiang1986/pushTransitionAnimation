...
//        UIPanGestureRecognizer *popRecognizer = [[UIPanGestureRecognizer alloc]initWithTarget:self action:@selector(handlePopRecognizer:)];
        UIScreenEdgePanGestureRecognizer *popgesure = [[UIScreenEdgePanGestureRecognizer alloc] initWithTarget:self action:@selector(handlePopRecognizer:)];
        popgesure.edges = UIRectEdgeLeft;

        [self.view addGestureRecognizer:popgesure];
        popgesure.delegate = self;
    }
